        ...
        <div>
            ...
            <div className="cloud-section">
                ...
                <div className="cloud-text">
                   ...
                   <p>Fuel innovation and adaptability with cloud computing. Vividnex helps organizations stay ahead and flourish in a rapidly changing digital landscape.</p>

                </div>
            </div>
            <h1 className='headings-1'>Why reinvent capital projects?</h1>
            <CapitalProjects />
            <h1 className='headings-1'><p>Reimagining infrastructure and capital projects <br></br> through AI</p></h1>
