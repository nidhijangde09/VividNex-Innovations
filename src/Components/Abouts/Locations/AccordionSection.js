...
const accordionData = [
  { title: "Africa", content: "VividNex has multiple offices across Africa. In Mauritius, we are located at 1 Cybercity - Ebene, Tower B & C, One Exchange Square, Wall Street, Ebene (72201); at Nexteracom Tower II, Ebene Cybercity; at Nex Tower, Rue du Savoir, Ebene Cybercity; and at Shri Atal Bihari Vajpayee Tower, Cyber Tower 1, Ebene Cyber City, Quatre Bornes.In Morocco, our Casablanca office is at Casanearshore (Sidi Maarouf), Shore 10, Park 1100 – Bd. Al Qods, Sidi Maarouf, Casablanca-Settat (20100).In South Africa, we are present in Cape Town at Convention Towers, C/o Heerengracht and Coen Steytler, Foreshore (8001), and in Johannesburg at Building No 3, Waterfall Corporate Campus, 74 Waterfall Drive, Waterval City (1685)." }, 
  ...
  { title: "Middle East", content: " In the Middle East, VividNex has established a strong presence with offices across several key countries. In Israel, the company operates from Atirei Yeda, Building 15 in Kfar Saba, and from the Tel Aviv Cyber Fusion Center located on Ha-Menofim Street. In Qatar, VividNex’s office is situated in Workinton, Burj Alfardan, within the Marina District of Lusail. In Saudi Arabia, there are offices in Al Khobar Gate Tower on King Abdulaziz Road, as well as in Riyadh, where operations are based in the Business Gate Complex on Airport Road and at the King Abdullah Financial District on King Fahd Road. In the United Arab Emirates, VividNex has offices in Abu Dhabi, located at Al Sila Tower in the Abu Dhabi Global Market Square on Al Maryah Island, and in Dubai, at Arenco Tower on Sheikh Zayed Road. " },
