...
const data = [
  {
    ...
    description: "We create transformative solutions that drive impact across industries and communities, leveraging AWS’s leading cloud technologies to modernize, optimize, and innovate at scale.",
