...
const data = [
  {
    ...
    description:
      "Leverage AWS’s world-leading cloud technologies to build solutions that transform industries, communities, and lives. Together, we empower organizations to modernize, optimize, and innovate at scale.",
    link: "#"
  },
  {
    id: 2,
    ...
    description:
      "Leverage Salesforce’s world-leading CRM and cloud solutions to build smarter, more connected experiences. Together, we empower organizations to engage customers, optimize operations, and drive growth at scale.",
    link: "#"
  },
  {
    id: 3,
